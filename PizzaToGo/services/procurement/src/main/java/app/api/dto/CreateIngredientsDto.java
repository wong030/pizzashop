...
public class CreateIngredientsDto {
    ...
    public CreateIngredientsDto() {

    }

    public CreateIngredientsDto( int ingredient1Id, int ingredient2Id,int ingredient3Id,int ingredient4Id, int ingredient5Id, int ingredient6Id, int ingredient7Id, int ingredient8Id) {
