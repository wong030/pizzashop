...
let PIZZALIST_TOPPINGS = {
  ...
  Diavolo:
    "Cheese, Tomato Sauce, Pepperoni sausage, Onions, Peppers, Chili peppers, Garlic",
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  let toppingsContainer = document.getElementById(
    "pizzaExtraToppingsContainer"
  );
...
function pizzaClicked(event) {
  ...
  document.getElementById("pizzaDetailsToppings").innerText =
    PIZZALIST_TOPPINGS[name];
...
function loginButtonClicked() {
  ...
  if (
    gridContainerMain.getAttribute("style") == null ||
